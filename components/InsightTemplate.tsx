...
export default function InsightTemplate({
  ...
  return (
    <div className="w-full px-4 md:px-4 py-16 text-[22px] leading-relaxed">
      ...
      {/* TITLE */}
      <h1 className="text-[48px] font-semibold mb-10 leading-tight">{title}</h1>
      ...
      <div className="relative mb-16 border-b border-gray-200">
        ...
        <div className="md:hidden flex items-center justify-between pb-4">
          ...
          <span className="font-medium text-center">{activeSection.label}</span>
      ...
      <div key={activeIndex}>
        ...
        <div className="rounded-2xl overflow-hidden mb-12 bg-gray-50 p-8">
          <Image
