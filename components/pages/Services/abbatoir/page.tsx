        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-col gap-12">
            ...
            <div className="flex flex-col items-center text-[#A5A5A5]">
              <img
                src="/img/bgabbtoir.svg"
                alt="Hero Image"
                className="w-full rounded-2xl"
              />
            </div>
            <p className="text-xl text-justify leading-8 indent-8">
              The Abattoir Mobile App digitizes livestock inspection,
              processing, and packaging activities into a unified mobile
              platform that ensures end-to-end traceability, regulatory
              compliance, and operational transparency within abattoir
              environments. By capturing real-time inspection data, processing
              records, and QR code–linked documentation, the app creates a
              reliable digital trail from slaughter to packaging, enabling
              accurate reporting, improved food safety, and seamless integration
              with the broader Ternaqin ecosystem.
            </p>
